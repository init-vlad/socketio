...
func (bc *broadcastRemote) SendAllExcept(event string, ids []string, args ...interface{}) {
	bc.local.sendAllExcept(event, ids, args...)
	bc.remote.local.sendAllExcept(event, ids, args...)
}
